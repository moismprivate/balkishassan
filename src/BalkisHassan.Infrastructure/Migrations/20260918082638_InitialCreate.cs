        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LegacyJoomlaId = table.Column<int>(type: "integer", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LegacyRedirects", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LegacyJoomlaId = table.Column<int>(type: "integer", nullable: true),
                    LegacyUrl = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_LegacyJoomlaId",
                table: "Categories",
                column: "LegacyJoomlaId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContactInfos_LegacyJoomlaId",
                table: "ContactInfos",
                column: "LegacyJoomlaId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ContentItems_CategoryId_IsPublished_PublishedAt",
                table: "ContentItems",
                columns: new[] { "CategoryId", "IsPublished", "PublishedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_ContentItems_LegacyJoomlaId",
                table: "ContentItems",
                column: "LegacyJoomlaId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExternalLinks_LegacyJoomlaId",
                table: "ExternalLinks",
                column: "LegacyJoomlaId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_LegacyRedirects_Source",
                table: "LegacyRedirects",
                column: "Source",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MediaItems_LegacyPath",
                table: "MediaItems",
                column: "LegacyPath");
